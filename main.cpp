...
void displayScene()
{
    ...
    */
    ...
    glRotatef(quadAngle, 0, 0, 1);
    glScalef(boxScaleFactor, boxScaleFactor, boxScaleFactor);
    glTranslatef(0, 0, (upperBoxHeight) + (smallBoxHeight)+4); // places the upp
    ...
    glRotatef(quadAngle, 0, 0, 1);
    glScalef(boxScaleFactor, boxScaleFactor, boxScaleFactor);
    glTranslatef(0,(s1BoxWidth/2) + (largeBoxWidth/2),-((largeBoxHeight/2)-10)); // places the small box on top of the large box
    ...
    glRotatef(quadAngle, 0, 0, 1);
    glScalef(boxScaleFactor, boxScaleFactor, boxScaleFactor);
    glTranslatef(0,smallBoxWidth/2, ((doorlBoxHeight)+updoorBoxHeight/2)); // places the small box on top of the large box
    displayBox9(updoorBoxLength, updoorBoxWidth, updoorBoxHeight); // updoor box// //(updoorBoxHeight/2)+ (doorlBoxHeight)+5)
    ...
    displayBox10(windowBoxLength, windowBoxWidth, windowBoxHeight); //  number 1 window
    glPopMatrix();
    ...
    displayBox11(upwinBoxLength, upwinBoxWidth, upwinBoxHeight); // number 1 window silling box
    glPopMatrix();
    ...
    glTranslatef(30,-(smallBoxWidth/2), (doorlBoxHeight/2)+ (s3BoxHeight/2)); // places the small box on top of the large box
    displayBox13(doorlBoxLength, doorlBoxWidth, doorlBoxHeight); // back left door box
    glPopMatrix();
    ...
    glTranslatef(bdoormovefactor,0,0);
    glTranslatef(-30,-(smallBoxWidth/2), (doorrBoxHeight/2)+ (s3BoxHeight/2)); // places the small box on top of the large box
    displayBox14(doorrBoxLength, doorrBoxWidth, doorrBoxHeight); // back rightt door box
    glPopMatrix();
    ...
    displayBox15(updoorBoxLength, updoorBoxWidth, updoorBoxHeight); // back door silling box
    glPopMatrix();
    ...
    glTranslatef(0,0,windowmovefactor);
    glTranslatef(-231, 0, (windowBoxHeight/2) + (largeBoxHeight/2)+50); // places the small box on top of the large box
    displayBox16(windowBoxLength, windowBoxWidth, windowBoxHeight); // number 2 window right side
    glPopMatrix();
    ...
    glScalef(boxScaleFactor, boxScaleFactor, boxScaleFactor);
    glTranslatef(-233,0, (upwinBoxHeight/2) + (largeBoxHeight/2)+140); // places the small box on top of the large box
    displayBox17(upwinBoxLength, upwinBoxWidth, upwinBoxHeight); //  number 2 window silling box right side
    glPopMatrix();
